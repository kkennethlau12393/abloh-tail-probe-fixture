 ...
 */
/* EXPORTED so `coverage-code-contract.test.mjs` can walk the vocabulary itself rather than carrying
   a THIRD hand-typed copy of it: a list that test wrote out by hand could pass while this one had
   drifted, which is the same class of gap the pin in capability-sync.test.ts closes upstream. */
export const L0_REASON_CODES = new Set([
